...
```bash
python -m py_compile scripts/muse_research_worker.py scripts/muse_cli_worker.py tests/test_muse_research_worker.py tests/test_muse_cli_worker.py
python -m unittest tests.test_muse_research_worker tests.test_muse_cli_worker
git diff --check -- scripts/muse_research_worker.py scripts/muse_cli_worker.py tests/test_muse_research_worker.py tests/test_muse_cli_worker.py codex-research-loop/skill/research-loop/SKILL.md codex-research-loop/skill/research-loop/references/muse-spark.md codex-research-loop/AGENTS.block.md codex-research-loop/README.md
```
